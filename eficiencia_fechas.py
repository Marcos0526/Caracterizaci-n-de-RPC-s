...
data = pd.read_csv('/Users/marcosbautista/Desktop/CSV/2_eficiencia_fechas.csv')
...
plt.title('Eficiencia de los datos recolectados',fontsize=28)
plt.xlabel('Fechas',fontsize=20)
plt.ylabel('Eficiencia (%)',fontsize=20)
plt.ylim(-7, 100)
plt.legend(fontsize=14)
plt.grid(True, axis='y')
 
intervalos = [ 28.5, 47.5,]
for x in intervalos:
...
plt.xticks(ticks=x_ticks, labels=x_labels, rotation=0, fontsize=16)
y_ticks = range(0, 101, 10)
plt.yticks(ticks=y_ticks, fontsize=16)
